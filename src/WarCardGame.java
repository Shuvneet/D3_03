...
public class WarCardGame {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            System.out.println("P1 plays card is " + p1Card.toString());
            System.out.println("P2 plays card is " + p2Card.toString());
            ...
            if(p1Card.getCard() > p2Card.getCard()){//if player 1 win 
                ...
                if(war1.size() == 3 && war2.size() == 3 ){
                    ...
                    if(war1.get(2).getCard() > war2.get(2).getCard()){
                        ...
                        deck1.addAll(war2);
                        System.out.println("P1 wins the war round");
                    }//end if
                    //otherwise player 2 wins the war round
                    else{
                        deck2.addAll(war1); //player2 get all 10 cards
                        deck2.addAll(war2);
                        System.out.println("P2 wins the war round");
                    }//end else                      
                }//end if
